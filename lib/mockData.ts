  ...
  mainProjects: [
    {
      ...
      userRole: "负责用户调研、需求分析、核心流程梳理和原型设计。",
      actions: [
        "访谈校园用户，梳理买家和卖家的核心痛点。",
        "拆解发布、搜索、沟通和交易确认流程。",
        "输出需求文档和低保真原型，推动团队对齐功能优先级。",
      ],
      result:
        "完成校园二手交易小程序核心功能设计，包括商品发布、分类浏览、搜索筛选和站内沟通流程。",
      riskPoints: [
        "项目结果数据不明确",
        "个人贡献不够具体",
        "用户调研样本未知",
...
export const mockInterviewTurns: InterviewTurn[] = [
  {
    ...
    userMock:
      "面试官您好，我是应届毕业生，目标岗位是产品经理。我在校期间做过校园二手交易小程序，负责用户调研、需求分析和原型设计。我想做产品经理，是因为我对用户需求和产品体验比较感兴趣，也希望通过产品能力解决真实问题。",
  },
  {
    stage: "动机追问",
    ...
    userMock:
      "在项目里，我主要体现了需求分析和原型设计能力。我们发现同学买卖二手物品时信息很分散，所以我整理了用户痛点，并把需求拆成发布、浏览、搜索和沟通几个模块，然后设计了对应页面。",
  },
  {
    stage: "项目追问",
    ...
    userMock:
      "项目背景是校园二手交易主要靠微信群，消息容易被刷掉。目标是让同学更方便地发布和找到二手物品。我负责前期调研、需求文档和原型设计，也参与了功能优先级讨论。",
  },
  {
    stage: "数据追问",
    type: "data_followup",
